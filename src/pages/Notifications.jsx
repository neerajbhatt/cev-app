...
const TYPE_STYLE = {
  action:   { bg: '#FFFBEB', border: '#FDE68A', icon: '⚠️', label: 'Action Required', color: '#92400E' },
  document: { bg: '#EFF6FF', border: '#BFDBFE', icon: '📄', label: 'Document',         color: '#1E40AF' },
  info:     { bg: '#F0FDF4', border: '#BBF7D0', icon: 'ℹ️',  label: 'Information',      color: '#166534' },
  warning:  { bg: '#FEF2F2', border: '#FECACA', icon: '🚨', label: 'Notice',           color: '#991B1B' },
}
  ...
  return (
    <div style={{ padding: '28px 32px', maxWidth: 800 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24 }}>
        <div>
          <h1 style={{ fontSize: 22, fontWeight: 700, color: '#002677' }}>Notifications</h1>
          <p style={{ color: '#64748b', fontSize: 14, marginTop: 4 }}>
            Portal alerts and updates about your benefits and compliance.
          </p>
        </div>
        {unreadCount > 0 && (
      ...
      <div style={{ background: '#F8FAFC', border: '1px solid #E2E8F0', borderRadius: 10, padding: '12px 16px', marginBottom: 20, fontSize: 13, color: '#64748b' }}>
        ℹ️ Official eligibility notices and determination letters are available through your state eligibility system. This portal displays informational alerts only.
      </div>
